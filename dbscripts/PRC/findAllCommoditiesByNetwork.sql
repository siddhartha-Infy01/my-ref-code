drop procedure findAllCommoditiesByNetwork;
delimiter $$
CREATE PROCEDURE findAllCommoditiesByNetwork(nwid VARCHAR(25))
BEGIN
  -- Temporary storage
...
UNTIL ROW_COUNT() = 0
  ...
  select a.* from commodities a,network_commodities b where a.commodity_id=b.commodity_id and b.network_id=nwid
  union

...
CREATE DEFINER=`esoko`@`%` PROCEDURE `queryNetworkLimits`(nwid VARCHAR(25))
BEGIN
...
DECLARE count INT DEFAULT 0;
 ...
 DECLARE share_cursor CURSOR FOR
    ...
    and subscription_category = 'L' and subscription_type=(select subscription_type from subscriber_master where network_id=nwid );

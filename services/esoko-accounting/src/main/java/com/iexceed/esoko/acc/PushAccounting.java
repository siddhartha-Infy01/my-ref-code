...
@Component
public class PushAccounting extends AbstractAccounting {
	@Autowired
	...
	public String doAccounting(Accounting accounting) {
		log.info("Entered Push Accounting");
		...
		Forex forex = null;
		Map<String, List<Map<ACCROLE, COSTROLE>>> ALERT = ROLETOHEAD.PUSH;
		...
		List<Map<ACCROLE, COSTROLE>> debits = ALERT.get(ROLETOHEAD.PUDEBIT);
		...
		List<Map<ACCROLE, COSTROLE>> credits = ALERT.get(ROLETOHEAD.PUCREDIT);

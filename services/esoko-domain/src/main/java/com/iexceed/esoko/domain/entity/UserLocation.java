...
/**
 * The persistent class for the user_locations database table.
 * 
 */
@Entity
...
public class UserLocation implements Serializable {
	...
	public UserLocationPK getId() {
		return this.id;
	}

	public void setId(UserLocationPK id) {
		this.id = id;
	}
	...
	public String toString() {
		return "UserLocation [id=" + id + ", createdBy=" + createdBy

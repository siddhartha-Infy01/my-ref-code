...
/**
 * The persistent class for the user_occupations database table.
 * 
 */
@Entity
...
public class UserOccupation implements Serializable {
	...
	public UserOccupationPK getId() {
		return this.id;
	}

	public void setId(UserOccupationPK id) {
		this.id = id;
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		UserOccupation other = (UserOccupation) obj;
		if (createdBy == null) {
	...
	public String toString() {
		return "UserOccupation [id=" + id + ", createdBy=" + createdBy

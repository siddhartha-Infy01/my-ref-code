...
public class InvoiceDetail implements Serializable {
	...
	public String toString() {
		return "InvoiceDetail [invoiceNo=" + invoiceNo + ", createdBy="
				+ createdBy + ", createdTs=" + createdTs + ", currency="
				+ currency + ", dueAmount=" + dueAmount + ", dso=" + dso
				+ ", invImage=" + Arrays.toString(invImage)
				+ ", invoiceAmount=" + invoiceAmount + ", invoiceDate="
				+ invoiceDate + ", invoiceFrom=" + invoiceFrom + ", invoiceTo="
				+ invoiceTo + ", modifiedBy=" + modifiedBy + ", modifiedTs="
				+ modifiedTs + ", paid_Date=" + paid_Date + ", paid_Status="
				+ paid_Status + "]";
	}
	...
	public int hashCode() {
		...
		result = prime * result
				+ ((dueAmount == null) ? 0 : dueAmount.hashCode());

...
/**
 * The persistent class for the subscription_limits_txn database table.
 * 
 */
@Entity
@Table(name="subscription_limits_txn")
@NamedQuery(name="SubscriptionLimitsTxn.findAll", query="SELECT s FROM SubscriptionLimitsTxn s")
public class SubscriptionLimitsTxn implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private SubscriptionLimitsTxnPK id;
	...
	public SubscriptionLimitsTxn() {
	}

	public SubscriptionLimitsTxnPK getId() {
		return this.id;
	}

	public void setId(SubscriptionLimitsTxnPK id) {
		this.id = id;
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		SubscriptionLimitsTxn other = (SubscriptionLimitsTxn) obj;
	...
	public String toString() {
		return "SubscriptionLimitsTxn [id=" + id + ", adminstrators="

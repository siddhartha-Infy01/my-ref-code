...
/**
 * The persistent class for the subscription_pricing database table.
 * 
 */
@Entity
@Table(name="subscription_pricing")
@NamedQuery(name="SubscriptionPricing.findAll", query="SELECT s FROM SubscriptionPricing s")
public class SubscriptionPricing implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private SubscriptionPricingPK id;
	...
	public SubscriptionPricingPK getId() {
		return this.id;
	}

	public void setId(SubscriptionPricingPK id) {
		this.id = id;
	}
	...
	public String toString() {
		return "SubscriptionPricing [id=" + id + ", agent=" + agent

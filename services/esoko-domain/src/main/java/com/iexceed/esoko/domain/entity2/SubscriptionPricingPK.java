...
/**
 * The primary key class for the subscription_pricing database table.
 * 
 */
@Embeddable
public class SubscriptionPricingPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof SubscriptionPricingPK)) {
			return false;
		}
		SubscriptionPricingPK castOther = (SubscriptionPricingPK)other;
		return 
	...
	public String toString() {
		return "SubscriptionPricingPK [subscriptionType=" + subscriptionType

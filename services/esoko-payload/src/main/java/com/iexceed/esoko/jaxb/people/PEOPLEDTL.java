...
/**
 * <p>Java class for PEOPLEDTL complex type.
 * 
 ...
 *         &lt;element name="NWKDTLS" type="{http://www.iexceed.com/viewGroupDetail}NWKDTLS" maxOccurs="unbounded"/>
 *         &lt;element name="CMMDTLS" type="{http://www.iexceed.com/viewGroupDetail}CMMDTLS" maxOccurs="unbounded"/>
 *         &lt;element name="OCCDTLS" type="{http://www.iexceed.com/viewGroupDetail}OCCDTLS" maxOccurs="unbounded"/>
 *         &lt;element name="EDITABLE" type="{http://www.iexceed.com/viewGroupDetail}EDITABLE"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "PEOPLEDTL", propOrder = {
    "peopleId",
    "edit",
    "firstName",
    "lastName",
...
public class PEOPLEDTL {
    ...
    @XmlElement(name = "NWKDTLS", namespace = "http://www.iexceed.com/viewGroupDetail", required = true)
    protected List<NWKDTLS> nwkdtls;
    @XmlElement(name = "CMMDTLS", namespace = "http://www.iexceed.com/viewGroupDetail", required = true)
    protected List<CMMDTLS> cmmdtls;
    @XmlElement(name = "OCCDTLS", namespace = "http://www.iexceed.com/viewGroupDetail", required = true)
    protected List<OCCDTLS> occdtls;
    @XmlElement(name = "EDITABLE", namespace = "http://www.iexceed.com/viewGroupDetail", required = true)

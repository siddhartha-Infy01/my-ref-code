...
/**
 * <p>Java class for COMMD_ATTRIBUTE complex type.
 * 
...
@XmlType(name = "COMMD_ATTRIBUTE", propOrder = {
    "attributeName"
})
public class COMMDATTRIBUTE {

    @XmlElement(name = "attribute_name", namespace = "http://www.iexceed.com/queryAllUnAuthCommodities", required = true)

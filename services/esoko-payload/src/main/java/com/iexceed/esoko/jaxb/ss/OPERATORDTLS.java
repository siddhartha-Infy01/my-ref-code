...
/**
 * <p>Java class for OPERATORDTLS complex type.
 * 
 ...
 *         &lt;element name="OPERATORS" type="{http://www.iexceed.com/queryGatewayDtls}OPERATORS" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "OPERATORDTLS", propOrder = {
    "countryName",
    "nuOfOperators",
    "operators"
})
public class OPERATORDTLS {

    @XmlElement(namespace = "http://www.iexceed.com/queryGatewayDtls", required = true)
    protected String countryName;
    @XmlElement(namespace = "http://www.iexceed.com/queryGatewayDtls", required = true)
    protected String nuOfOperators;
    @XmlElement(name = "OPERATORS", namespace = "http://www.iexceed.com/queryGatewayDtls", required = true)
